            ...
            <table class="table table-striped table-hover">
                ...
                <#list page.records as entity>
                    <tr>
                        ...
                        <td>
                            <#if  entity.ishot == 1 >
                                <a class="btn btn-success btn-xs hotBtn" href="javascript:;" data-hot='0'
                                   data-id="${entity.id}">
                                    <span class="glyphicon glyphicon-minus-sign"></span> 取消热门
                                </a>

                            <#else>
                                <a class="btn btn-default btn-xs hotBtn" href="JavaScript:;" data-hot="1"
                                   data-id="${entity.id}">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="/region/saveOrUpdate" method="post" id="editForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select class="form-control selectpicker " multiple id="refIds" name="refIds"
