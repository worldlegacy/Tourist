...
var vue = new Vue({
    ...
    methods: {
        ...
        queryComments: function (travelId) {
            //游记评论不分页
            ajaxGet("/travels/comments", {travelId: travelId},
                function (data) {
    ...
    mounted: function () {
        ...
        //吐司
        ajaxGet("/destinations/toasts", {destId: param.destId},
            function (data) {
        ...
        //点击量前3的攻略文章
        ajaxGet("/destinations/strategies/viewnumTop3", {destId: param.destId},
            function (data) {
                vue.strategies = data.data;
            })

        //点击量前3的游记文章
        ajaxGet("/destinations/travels/viewnumTop3", {destId: param.destId},
            function (data) {
